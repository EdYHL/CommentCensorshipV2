...
def censor():
    ...
    try:
        ...
        return {
            'containsWebsite': contains_website,
            'data': data,
                }
...
if __name__ == '__main__':
    ...
    HanLP = hanlp.load(hanlp.pretrained.mtl.CLOSE_TOK_POS_NER_SRL_DEP_SDP_CON_ELECTRA_SMALL_ZH, devices=0)  # 分词gpu
    # sts = hanlp.load(hanlp.pretrained.sts.STS_ELECTRA_BASE_ZH)
    sts = hanlp.load(hanlp.pretrained.sts.STS_ELECTRA_BASE_ZH, devices=1)  # gpu
